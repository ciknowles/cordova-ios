...
class ProjectCreator {
    ...
    updatePlatformConfigFile () {
        ...
        const configXmlPath = this.projectPath('CApp', 'config.xml');
    ...
    updateProjectSettings () {
        const projectPath = this.projectPath('CApp.xcodeproj', 'project.pbxproj');
        const xcodeproj = xcode.project(projectPath);
        xcodeproj.parseSync();

        xcodeproj.updateBuildProperty('PRODUCT_NAME', `"${this.project.name}"`, null, 'CApp');
        xcodeproj.updateBuildProperty('PRODUCT_BUNDLE_IDENTIFIER', `"${this.project.id}"`, null, 'CApp');
